...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("foxy-databaseutils-common", "com.github.CakeyFox.DatabaseUtils", "core").version("1.4.7")
            library("foxy-databaseutils-jvm", "com.github.CakeyFox.DatabaseUtils", "core-jvm").version("1.4.7")
