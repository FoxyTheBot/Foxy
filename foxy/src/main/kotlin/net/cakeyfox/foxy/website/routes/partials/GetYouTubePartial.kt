...
import frontend.htmx.partials.getYouTubeSettings
...
class GetYouTubePartial {
    @OptIn(ExperimentalKtorApi::class)
    fun Routing.getYouTubePartial(server: FoxyWebsite) {
        route("/{lang}/partials/{guildId}/youtube") {
            hx.get {
