...
import net.cakeyfox.foxy.website.frontend.pages.premiumPage
...
class GetPremiumPage(val server: FoxyWebsite) : BaseRoute("/premium") {
    override suspend fun handle(context: RoutingContext, locale: FoxyLocale) {
        ...
        respondWithPage(context.call) { premiumPage(user, lang) }
    }
}