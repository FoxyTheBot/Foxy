...
module.exports = {
    ...
    message.reply(`${client.emotes.broken} **|** Então é o fim? Você quer realmente se divorciar de **${user.username}**?`).then((msg) => {
  ...
  msg.react('💔');
    ...
    yesCollector.on('collect', () => {
     ...
     message.reply(`${client.emotes.broken} **|** ${message.author} ...Então é isso, se divorciar é sim uma coisa triste, Da próxima vez ame alguém que realmente mereça e respeite você, sim isso parece ser difícil pois o amor é algo cego e incontrolável... Mas é melhor estar sozinho do que mal acompanhado, eu confio em você! :heart:`)
