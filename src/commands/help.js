...
exports.run = async (client, message) => {
 message.delete().catch(O_o => {});
  ...
  .addField(`<:DiscordDeveloper:731945244983034033> Está com dúvidas? Entre no meu servidor de suporte`, `https://discord.gg/nHVqcxrFmg`)
  ...
  .addField(`<:bug_hunter:789668194494709761> Encontrou algum bug?`, `Use f!report para reportar seu bug.`)
