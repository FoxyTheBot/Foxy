module.exports = { 
    ...
    if ( !message.member.roles.cache.has("802973366860251158") ) message.member.roles.add("802973366860251158"), message.channel.send("Agora você vai receber todas as minhas novidades <:meow_blush:768292358458179595>")
