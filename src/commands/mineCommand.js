...
module.exports = {
    ...
    if (mine !== null && timeout - (Date.now() - mine) > 0) {
      ...
      message.channel.send(`:x: **|** Você minerou e está cansado tente novamente em **${time.hours}h ${time.minutes}m ${time.seconds}s**`);
    } else {
       ...
       switch(args[0]) {
            ...
            case "madeira":
                ...
                message.channel.send(`<:Minecraft:804858374780878868> **|** Você minerou e conseguiu ${coal} Carvões`)
            ...
            case "pedra":
                ...
                message.channel.send(`<:Minecraft:804858374780878868> **|** Você minerou e conseguiu ${coal} Carvões, ${iron} Ferros`)
                db.set(`mine_${message.author.id}`, Date.now());
            ...
            message.channel.send(`<:Minecraft:804858374780878868> **|** Você minerou e conseguiu ${coal} Carvões, ${iron} Ferros, ${emerald} Esmeraldas, ${diamond} Diamantes`)
            db.set(`mine_${message.author.id}`, Date.now());
