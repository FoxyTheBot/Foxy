...
module.exports = {
  ...
  async run(client, message, args) {
    ...
    let text = args.join(' ').toUpperCase();
	               if (!text) return message.inlineReply('Insira um texto ou um código para ser decodificado ou codificado'); // but you can change the answer :)
    ...
    await message.inlineReply(morsereader);
  },
