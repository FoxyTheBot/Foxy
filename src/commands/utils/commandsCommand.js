  ...
  async run(client, message, args) {
    const CommandsEmbed = new MessageEmbed()
      ...
      .addFields(
        ...
        { name: "<:DiscordStaff:731947814246154240> **| Utilitários**", value: "`report`, `donate`, `remind`, `invite`, `github`, `dbl`, `calc`, `translate`, `ping`, `ascii`, `morse`, `weather`, `servericon`, `rbuser`", inline: true }
      )
