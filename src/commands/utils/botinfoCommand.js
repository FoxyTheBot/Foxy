      ...
      .then((results) => {
        ...
        const ajuda = new Discord.MessageEmbed()
          ...
          .addFields(
            ...
            { name: '👑 Menções Incríveis', value: `• **WinG4merBR#8379** | Se não fosse ele, eu nem iria existir \n • **Bis❄#2332** | Por fazer meu icon e outros desenhos :heart: \n • **Arthur Kohler** | Por me ajudar a ficar online! :heart: \n • **ThierrY** | Por me ajudar fazendo divulgações :3 :heart: \n • Todas as **${totalMembers}** pessoas que usaram meus comandos \n • E você ${message.author} que está falando comigo!` },
          )
          .setFooter('Foxy foi criada por WinG4merBR#8379', 'https://cdn.discordapp.com/attachments/792745835607752715/832677709288702022/5f1454f18ec74902ffc7c3f75a4d0dea.png');

        message.FoxyReply(ajuda);
      });
  },
