...
exports.run = async (client, message, args) => {
  ...
  if (user == 737044809650274325) return message.channel.send('Eu dou nota **10** para <@737044809650274325> sim eu sou muito linda 😘')
       if(user == 758885367847190568) return message.channel.send(`Sobre ${user}... Eu dou nota **100** para essa waifu. Essa waifu é perfeita! Eu não trocaria ela por nada se fosse você! <:meow_blush:768292358458179595>`)
    if(user == 331243426941239297) return message.channel.send(`Sobre ${user}... Eu dou nota **1000** para essa waifu. Essa waifu é perfeita! Eu não trocaria ela por nada se fosse você! <:meow_blush:768292358458179595>`)
