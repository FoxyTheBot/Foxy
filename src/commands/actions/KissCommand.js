...
module.exports = class KissCommand extends Command {
    ...
    async execute(interaction) {
        ...
        if (user == this.client.user) return interaction.editReply("🙅‍♀️ **|** Nah, eu não quero te beijar!");
        if (!user) return interaction.editReply('lembre-se de mencionar um usuário válido para beijar!');
